...
gulp.task('copy_other_css',function () {
    return gulp.src('./public/3rdLibs/css/**')
        .pipe(gulp.dest('./dist/public/3rdLibs/css'))
});
...
gulp.task('dist_copy_js',function () {
   return gulp.src('./src/public/www/js/*.js')
       .pipe(gulp.dest('./dist/public/www/js'))
       .pipe(gulpConnect.reload())
});
...
gulp.task('watch',function () {
    gulp.watch(['./src/*.html','./src/include/*.html'],['dist_fileinclude_cn']);

    gulp.watch('./src/public/www/css/*.css',['dist_copy_css']);

    gulp.watch('./src/public/www/js/*.js',['dist_copy_js']);
});
